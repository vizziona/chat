...
import { MaterialIcons, Ionicons, MaterialCommunityIcons,Foundation,FontAwesome5 } from '@expo/vector-icons';
    ...
    >
      ...
      <Tab.Screen
        ...
        tabBarIndicator: () => (
            ...
            tabBarIcon: () => (
                // <MaterialCommunityIcons name="video-camera" size={24} color="white" />
